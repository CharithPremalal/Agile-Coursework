                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12">
                                    {!! Form::model($employee, ['method'=>'PATCH' , 'action'=>['UsersController@update',$employee->id]]) !!}
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    {!! Form:: select('role_id', [''=>'-- Choose Options --'] + $roles , null,['class'=>'form-control', 'required'=> 'true']) !!}
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    {!! Form:: number('phone_number', null,['class'=>'form-control', 'required'=> 'true']) !!}
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                            ...
                                            <a href="{{url('employee-list')}}" class="btn btn-danger ">
                                                <span>Cancel</span>
                                            </a>
                                    {!! Form::close() !!}
                                    </div>
