                                    ...
                                    {!! Form::open(['method'=>'POST' , 'action'=>'TaskController@store']) !!}
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    {!! Form:: date('date', Carbon\Carbon::today()->format('Y-m-d'),['class'=>'form-control' , 'name'=>'date', 'required'=> 'true', 'readonly'=>'true']) !!}
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="inputOccupation4">Occupation</label>
                                                    <!-- <select id="Occupation" name="assigned_person" class="form-control">
