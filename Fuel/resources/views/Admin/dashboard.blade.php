        ...
        <div class="site-width">
            ...
            <ul id="side-menu" class="sidebar-menu">
                <li class="dropdown active"><a href="#"><i class="icon-home mr-1"></i> Dashboard</a>
                    <ul>
                        <li class="active"><a href="/dashboard"><i class="icon-grid"></i> Analytic</a></li>
                    ...
                    <div class="card">
                        <div class="card-body p-0">
                            <div class='p-4 align-self-center'>
                                <h2>{{$done}}</h2>
                                <h6 class="card-liner-subtitle">Done</h6>
                            </div>
                            <div class="barfiller" data-color="#1e3d73">
                                ...
                                <span class="fill" data-percentage="{{$doneRound}}"></span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body p-0">
                            ...
                            <div class="barfiller" data-color="#17a2b8">
                                ...
                                <span class="fill" data-percentage="{{$donePending}}"></span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
                <div class="col-12 mt-3">
                    <div class="card">
                        ...
                        <h4 class="card-title">All Check-list</h4>
                            <!-- <a href="{{url('to-do-list-add')}}" class="bg-primary py-2 px-2 rounded m-auto text-white ">
                                ...
                                <table id="example" class="display table dataTable table-striped table-bordered">
                                    ...
                                    @foreach($tasks as $task)
                                        <tr>
                                            ...
                                            @else
                                            <a type="button" class="btn btn-primary" style="color: #fff">Done</a>                  
                                            @endif
